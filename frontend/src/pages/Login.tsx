...
import { Mail, Key, Shield, AlertTriangle } from 'lucide-react';
      ...
      >
        <Card className="shadow-2xl border-white/40">
          <CardHeader className="space-y-3 pb-6 pt-8 items-center text-center">
            ...
            <CardTitle className="text-3xl font-bold tracking-tight">Lab Slot Engine</CardTitle>
            <CardDescription className="text-base">Enter your credentials to access the grid.</CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
              <motion.div
